...
managed namespace. First, find the RPA name from your `ReleasePlan`:
...
[,shell,subs="+quotes"]
----
$ oc get releaseplanadmission __<rpa-name>__ -n __<managed-namespace>__ -o yaml | yq .spec.policy
----
